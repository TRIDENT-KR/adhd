...
1. "add_single_task"
   ...
   - Rules:
     ...
     - "category": "Appointment" for one-time specific tasks; "Routine" for repeating daily habits.
     - "recurrence": null for daily routines; use "weekly"/"monthly" etc. only for explicit repeating appointments.
